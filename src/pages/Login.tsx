...
export default function Login() {
  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden">
      {/* Top Status Bar */}
      ...
      <main className="w-full max-w-[440px] flex flex-col pt-12 pb-12 z-10">
        {/* Logo */}
